...
ORIGINAL_INSTRUCTION = 0xE5C0200F
OFFSET_EU = 0x204DB04-0x2000000
OFFSET_US = 0x204D7CC-0x2000000
OFFSET_JP = 0x204DB2C-0x2000000
...
class PatchHandler(AbstractPatchHandler, DependantPatch):
    ...
    @property
    def name(self) -> str:
        return 'AlwaysAllowPortraitDefault'

    @property
    def description(self) -> str:
        return "Makes the game always use the Normal portrait as a fallback instead of showing no portait when a portrait is missing."
