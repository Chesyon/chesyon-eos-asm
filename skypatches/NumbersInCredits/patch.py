...
ORIGINAL_INSTRUCTION_EU = 0xEA00001C
ORIGINAL_INSTRUCTION_US = 0xEA000025
ORIGINAL_INSTRUCTION_JP = 0xEA000025
OFFSET_EU = 0x202708C-0x2000000
OFFSET_US = 0x2026D74-0x2000000
OFFSET_JP = 0x20270E4-0x2000000
...
class PatchHandler(AbstractPatchHandler, DependantPatch): # If the patch uses overlay 36, comment the above line and uncomment this line.
    ...
    @property
    def name(self) -> str:
        return 'NumbersInCredits'

    @property
    def description(self) -> str:
        return "Allows the credits font to properly display numbers."
