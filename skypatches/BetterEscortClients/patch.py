...
ORIGINAL_INSTRUCTION = 0xE19110F0
OFFSET_US = 0x4E884
OFFSET_EU = 0x4EBBC # no fancy calculations needed, it's just arm9 so subtract 0x200000
OFFSET_JP = 0x4EBDC
...
class PatchHandler(AbstractPatchHandler, DependantPatch):
    ...
    @property
    def name(self) -> str:
        return 'BetterEscortClients'

    @property
    def description(self) -> str:
        return "Escort clients will match the level of the highest level in the party. (PREVIEW)"
